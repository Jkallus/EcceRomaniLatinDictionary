...
//            if self.searchDisplayController!.active{
//                let indexPath = self.searchDisplayController!.searchResultsTableView.indexPathForSelectedRow()!
//                (segue.destinationViewController as! NonConjugatableDetailViewController).nonConjugatableWord = sortedFilteredWordsArray[indexPath.row]
//            }
//            else{
//                let indexPath = self.tableView.indexPathForSelectedRow()!
//                (segue.destinationViewController as! NonConjugatableDetailViewController).nonConjugatableWord = sortedWordsArray[indexPath.row]
//            }
//        }
//            
